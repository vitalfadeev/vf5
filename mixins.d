...
// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(299,1)
enum {FIF_UNKNOWN = FREE_IMAGE_FORMAT.FIF_UNKNOWN,FIF_BMP = FREE_IMAGE_FORMAT.FIF_BMP,FIF_ICO = FREE_IMAGE_FORMAT.FIF_ICO,FIF_JPEG = FREE_IMAGE_FORMAT.FIF_JPEG,FIF_JNG = FREE_IMAGE_FORMAT.FIF_JNG,FIF_KOALA = FREE_IMAGE_FORMAT.FIF_KOALA,FIF_LBM = FREE_IMAGE_FORMAT.FIF_LBM,FIF_IFF = FREE_IMAGE_FORMAT.FIF_IFF,FIF_MNG = FREE_IMAGE_FORMAT.FIF_MNG,FIF_PBM = FREE_IMAGE_FORMAT.FIF_PBM,FIF_PBMRAW = FREE_IMAGE_FORMAT.FIF_PBMRAW,FIF_PCD = FREE_IMAGE_FORMAT.FIF_PCD,FIF_PCX = FREE_IMAGE_FORMAT.FIF_PCX,FIF_PGM = FREE_IMAGE_FORMAT.FIF_PGM,FIF_PGMRAW = FREE_IMAGE_FORMAT.FIF_PGMRAW,FIF_PNG = FREE_IMAGE_FORMAT.FIF_PNG,FIF_PPM = FREE_IMAGE_FORMAT.FIF_PPM,FIF_PPMRAW = FREE_IMAGE_FORMAT.FIF_PPMRAW,FIF_RAS = FREE_IMAGE_FORMAT.FIF_RAS,FIF_TARGA = FREE_IMAGE_FORMAT.FIF_TARGA,FIF_TIFF = FREE_IMAGE_FORMAT.FIF_TIFF,FIF_WBMP = FREE_IMAGE_FORMAT.FIF_WBMP,FIF_PSD = FREE_IMAGE_FORMAT.FIF_PSD,FIF_CUT = FREE_IMAGE_FORMAT.FIF_CUT,FIF_XBM = FREE_IMAGE_FORMAT.FIF_XBM,FIF_XPM = FREE_IMAGE_FORMAT.FIF_XPM,FIF_DDS = FREE_IMAGE_FORMAT.FIF_DDS,FIF_GIF = FREE_IMAGE_FORMAT.FIF_GIF,FIF_HDR = FREE_IMAGE_FORMAT.FIF_HDR,FIF_FAXG3 = FREE_IMAGE_FORMAT.FIF_FAXG3,FIF_SGI = FREE_IMAGE_FORMAT.FIF_SGI,FIF_EXR = FREE_IMAGE_FORMAT.FIF_EXR,FIF_J2K = FREE_IMAGE_FORMAT.FIF_J2K,FIF_JP2 = FREE_IMAGE_FORMAT.FIF_JP2,FIF_PFM = FREE_IMAGE_FORMAT.FIF_PFM,FIF_PICT = FREE_IMAGE_FORMAT.FIF_PICT,FIF_RAW = FREE_IMAGE_FORMAT.FIF_RAW,FIF_WEBP = FREE_IMAGE_FORMAT.FIF_WEBP,FFI_JXR = FREE_IMAGE_FORMAT.FFI_JXR,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(316,1)
enum {FIT_UNKNOWN = FREE_IMAGE_TYPE.FIT_UNKNOWN,FIT_BITMAP = FREE_IMAGE_TYPE.FIT_BITMAP,FIT_UINT16 = FREE_IMAGE_TYPE.FIT_UINT16,FIT_INT16 = FREE_IMAGE_TYPE.FIT_INT16,FIT_UINT32 = FREE_IMAGE_TYPE.FIT_UINT32,FIT_INT32 = FREE_IMAGE_TYPE.FIT_INT32,FIT_FLOAT = FREE_IMAGE_TYPE.FIT_FLOAT,FIT_DOUBLE = FREE_IMAGE_TYPE.FIT_DOUBLE,FIT_COMPLEX = FREE_IMAGE_TYPE.FIT_COMPLEX,FIT_RGB16 = FREE_IMAGE_TYPE.FIT_RGB16,FIT_RGBA16 = FREE_IMAGE_TYPE.FIT_RGBA16,FIT_RGBF = FREE_IMAGE_TYPE.FIT_RGBF,FIT_RGBAF = FREE_IMAGE_TYPE.FIT_RGBAF,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(326,1)
enum {FIC_MINISWHITE = FREE_IMAGE_COLOR_TYPE.FIC_MINISWHITE,FIC_MINISBLACK = FREE_IMAGE_COLOR_TYPE.FIC_MINISBLACK,FIC_RGB = FREE_IMAGE_COLOR_TYPE.FIC_RGB,FIC_PALETTE = FREE_IMAGE_COLOR_TYPE.FIC_PALETTE,FIC_RGBALPHA = FREE_IMAGE_COLOR_TYPE.FIC_RGBALPHA,FIC_CMYK = FREE_IMAGE_COLOR_TYPE.FIC_CMYK,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(332,1)
enum {FIQ_WUQUANT = FREE_IMAGE_QUANTIZE.FIQ_WUQUANT,FIQ_NNQUANT = FREE_IMAGE_QUANTIZE.FIQ_NNQUANT,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(343,1)
enum {FID_FS = FREE_IMAGE_DITHER.FID_FS,FID_BAYER4x4 = FREE_IMAGE_DITHER.FID_BAYER4x4,FID_BAYER8x8 = FREE_IMAGE_DITHER.FID_BAYER8x8,FID_CLUSTER6x6 = FREE_IMAGE_DITHER.FID_CLUSTER6x6,FID_CLUSTER8x8 = FREE_IMAGE_DITHER.FID_CLUSTER8x8,FID_CLUSTER16x16 = FREE_IMAGE_DITHER.FID_CLUSTER16x16,FID_BAYER16x16 = FREE_IMAGE_DITHER.FID_BAYER16x16,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(355,1)
enum {FIJPEG_OP_NONE = FREE_IMAGE_JPEG_OPERATION.FIJPEG_OP_NONE,FIJPEG_OP_FLIP_H = FREE_IMAGE_JPEG_OPERATION.FIJPEG_OP_FLIP_H,FIJPEG_OP_FLIP_V = FREE_IMAGE_JPEG_OPERATION.FIJPEG_OP_FLIP_V,FIJPEG_OP_TRANSPOSE = FREE_IMAGE_JPEG_OPERATION.FIJPEG_OP_TRANSPOSE,FIJPEG_OP_TRANSVERSE = FREE_IMAGE_JPEG_OPERATION.FIJPEG_OP_TRANSVERSE,FIJPEG_OP_ROTATE_90 = FREE_IMAGE_JPEG_OPERATION.FIJPEG_OP_ROTATE_90,FIJPEG_OP_ROTATE_180 = FREE_IMAGE_JPEG_OPERATION.FIJPEG_OP_ROTATE_180,FIJPEG_OP_ROTATE_270 = FREE_IMAGE_JPEG_OPERATION.FIJPEG_OP_ROTATE_270,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(362,1)
enum {FITMO_DRAGO03 = FREE_IMAGE_TMO.FITMO_DRAGO03,FITMO_REINHARD05 = FREE_IMAGE_TMO.FITMO_REINHARD05,FITMO_FATTAL02 = FREE_IMAGE_TMO.FITMO_FATTAL02,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(372,1)
enum {FILTER_BOX = FREE_IMAGE_FILTER.FILTER_BOX,FILTER_BICUBIC = FREE_IMAGE_FILTER.FILTER_BICUBIC,FILTER_BILINEAR = FREE_IMAGE_FILTER.FILTER_BILINEAR,FILTER_BSPLINE = FREE_IMAGE_FILTER.FILTER_BSPLINE,FILTER_CATMULLROM = FREE_IMAGE_FILTER.FILTER_CATMULLROM,FILTER_LANCZOS3 = FREE_IMAGE_FILTER.FILTER_LANCZOS3,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(387,1)
enum {FICC_RGB = FREE_IMAGE_COLOR_CHANNEL.FICC_RGB,FICC_RED = FREE_IMAGE_COLOR_CHANNEL.FICC_RED,FICC_GREEN = FREE_IMAGE_COLOR_CHANNEL.FICC_GREEN,FICC_BLUE = FREE_IMAGE_COLOR_CHANNEL.FICC_BLUE,FICC_ALPHA = FREE_IMAGE_COLOR_CHANNEL.FICC_ALPHA,FICC_BLACK = FREE_IMAGE_COLOR_CHANNEL.FICC_BLACK,FICC_REAL = FREE_IMAGE_COLOR_CHANNEL.FICC_REAL,FICC_IMAG = FREE_IMAGE_COLOR_CHANNEL.FICC_IMAG,FICC_MAG = FREE_IMAGE_COLOR_CHANNEL.FICC_MAG,FICC_PHASE = FREE_IMAGE_COLOR_CHANNEL.FICC_PHASE,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(410,1)
enum {FIDT_NOTYPE = FREE_IMAGE_MDTYPE.FIDT_NOTYPE,FIDT_BYTE = FREE_IMAGE_MDTYPE.FIDT_BYTE,FIDT_ASCII = FREE_IMAGE_MDTYPE.FIDT_ASCII,FIDT_SHORT = FREE_IMAGE_MDTYPE.FIDT_SHORT,FIDT_LONG = FREE_IMAGE_MDTYPE.FIDT_LONG,FIDT_RATIONAL = FREE_IMAGE_MDTYPE.FIDT_RATIONAL,FIDT_SBYTE = FREE_IMAGE_MDTYPE.FIDT_SBYTE,FIDT_UNDEFINED = FREE_IMAGE_MDTYPE.FIDT_UNDEFINED,FIDT_SSHORT = FREE_IMAGE_MDTYPE.FIDT_SSHORT,FIDT_SLONG = FREE_IMAGE_MDTYPE.FIDT_SLONG,FIDT_SRATIONAL = FREE_IMAGE_MDTYPE.FIDT_SRATIONAL,FIDT_FLOAT = FREE_IMAGE_MDTYPE.FIDT_FLOAT,FIDT_DOUBLE = FREE_IMAGE_MDTYPE.FIDT_DOUBLE,FIDT_IFD = FREE_IMAGE_MDTYPE.FIDT_IFD,FIDT_PALETTE = FREE_IMAGE_MDTYPE.FIDT_PALETTE,FIDT_LONG8 = FREE_IMAGE_MDTYPE.FIDT_LONG8,FIDT_SLONG8 = FREE_IMAGE_MDTYPE.FIDT_SLONG8,FIDT_IFD8 = FREE_IMAGE_MDTYPE.FIDT_IFD8,}

// expansion at ../../.dub/packages/bindbc-freeimage/1.1.0/bindbc-freeimage/source/bindbc/freeimage/types.d(427,1)
enum {FIMD_NODATA = FREE_IMAGE_MDMODEL.FIMD_NODATA,FIMD_COMMENTS = FREE_IMAGE_MDMODEL.FIMD_COMMENTS,FIMD_EXIF_MAIN = FREE_IMAGE_MDMODEL.FIMD_EXIF_MAIN,FIMD_EXIF_EXIF = FREE_IMAGE_MDMODEL.FIMD_EXIF_EXIF,FIMD_EXIF_GPS = FREE_IMAGE_MDMODEL.FIMD_EXIF_GPS,FIMD_EXIF_MAKERNOTE = FREE_IMAGE_MDMODEL.FIMD_EXIF_MAKERNOTE,FIMD_EXIF_INTEROP = FREE_IMAGE_MDMODEL.FIMD_EXIF_INTEROP,FIMD_IPTC = FREE_IMAGE_MDMODEL.FIMD_IPTC,FIMD_XMP = FREE_IMAGE_MDMODEL.FIMD_XMP,FIMD_GEOTIFF = FREE_IMAGE_MDMODEL.FIMD_GEOTIFF,FIMD_ANIMATION = FREE_IMAGE_MDMODEL.FIMD_ANIMATION,FIMD_CUSTOM = FREE_IMAGE_MDMODEL.FIMD_CUSTOM,FIMD_EXIF_RAW = FREE_IMAGE_MDMODEL.FIMD_EXIF_RAW,}
